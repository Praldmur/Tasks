...
PG_DB = 'rental_3'
PG_USER = 'postgres'
PG_PASS = '911611911'  # замените на ваш пароль
...
def main():
    ...
    DROP TABLE IF EXISTS Lease_objects CASCADE;
    DROP TABLE IF EXISTS Leases CASCADE;
    DROP TABLE IF EXISTS Staff CASCADE;
    DROP TABLE IF EXISTS Clients CASCADE;
    DROP TABLE IF EXISTS Objects CASCADE;
    DROP TABLE IF EXISTS Object_types CASCADE;
    DROP TABLE IF EXISTS Facilitys CASCADE;
    DROP TABLE IF EXISTS Grade_remoteness CASCADE;
    ''')

    cursor.execute('''
    CREATE TABLE Grade_remoteness (
        grade_remoteness_id SERIAL PRIMARY KEY,
        ponds_nearest REAL
    );
    ''')
    ...
    CREATE TABLE Objects (
        ...
        facility_id INTEGER REFERENCES Facilitys(facility_id),
        ...
        grade_remoteness_id INTEGER REFERENCES Grade_remoteness(grade_remoteness_id),
        rent_price REAL
    );
    ''')
    ...
    print(f"База данных PostgreSQL '{PG_DB}' успешно создана и заполнена данными.")
